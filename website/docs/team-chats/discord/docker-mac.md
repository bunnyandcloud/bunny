...
**First time with Discord?** Create the application and invite the bot to your server first — see [Discord application and server setup](./setup#discord-application-and-server) (Steps 1–2), then continue below.
...
Full guide: [Discord setup](./setup).
