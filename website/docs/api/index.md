...
OpenAPI spec: [openapi.yaml on GitHub](https://github.com/bunnyandcloud/bunny/blob/main/packages/api-contracts/openapi.yaml)

WebSocket events: [events.schema.json on GitHub](https://github.com/bunnyandcloud/bunny/blob/main/packages/realtime-protocol/events.schema.json)
...
See [Discord setup](../team-chats/discord/setup).
